...
let analyser, dataArray, audioCtx, bar, dbValue, avgDbText, maxDbText;
...
function updateMeter() {
  ...
  const maxDb = Math.max(...dbHistory);
...
function initMic() {
  ...
  avgDbText = document.getElementById("avg-db");
  maxDbText = document.getElementById("max-db");
